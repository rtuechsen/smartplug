...
import {
	DeviceTreeItemLabel,
	DeviceTreeItemLabelProps,
} from "./DeviceTreeItemLabel";
 ...
 */
export interface DeviceTreeItemProps
...
export function DeviceTreeItem(
	...
	const [isAvailableState, setIsAvailableState] = React.useState<boolean>(
