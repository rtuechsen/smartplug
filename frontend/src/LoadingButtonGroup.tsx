...
export function LoadingButton({
	...
	sx,
	ref,
}: React.PropsWithChildren<LoadingButtonProps>): JSX.Element {
...
export function LoadingButtonGroup({
	...
	buttonLabelLeft,
	buttonLabelRight,
}: LoadingButtonGroupProps): JSX.Element {
	return (
		<ButtonGroup size="small">
			<LoadingButton onClick={onClickLeftButton} variant="outlined">
				{buttonLabelLeft}
			</LoadingButton>
			<LoadingButton onClick={onClickRightButton} variant="outlined">
				{buttonLabelRight}
			</LoadingButton>
		</ButtonGroup>
	);
